...
export default function Cube({key,title,color}) {
  return (
    // <Paper elevation={0}  variant="outlined" square style={{height:"40px",width:"40px"}}>
      <Button variant="text" disableElevation size='large' style={{backgroundColor:color,borderRadius:'0'}} square>{title}</Button>
      // {/* </Paper> */}
